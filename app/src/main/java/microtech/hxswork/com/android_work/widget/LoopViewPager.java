...
import microtech.hxswork.com.android_work.adapter.LoopPagerAdapterWrapper;

/**
 * Created by microtech on 2017/9/19.
 */
...
public class LoopViewPager extends ViewPager {
    ...
    public void autoLoop(boolean isAuto) {
        ...
        if (isAuto) {
            mHandler.sendEmptyMessageDelayed(HANDLE_LOOP_MSG, 2000);
        } else {
