package microtech.hxswork.com.android_work.serviceui;
...
public class NestingScrollPlanLayout extends ViewGroup implements NestedScrollingParent {
    ...
    public static int mTargetInitOffset;
    ...
    public NestingScrollPlanLayout(Context context, AttributeSet attrs) {
        ...
        mHeaderInitOffset = array.getDimensionPixelSize(R.styleable.EventDispatchPlanLayout_header_init_offset, Util.dp2px(getContext(), 20));
        mTargetInitOffset = array.getDimensionPixelSize(R.styleable.EventDispatchPlanLayout_target_init_offset, Util.dp2px(getContext(), 180));
