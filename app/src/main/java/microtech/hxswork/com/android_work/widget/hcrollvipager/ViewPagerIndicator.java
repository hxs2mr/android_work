...
public class ViewPagerIndicator extends LinearLayout {
	...
	// 标题正常时的颜色
	private static final int COLOR_TEXT_NORMAL = 0x8FACC8;

	//标题选中时的颜色
	private static final int COLOR_TEXT_HIGHLIGHTCOLOR = 0xe5004f;
	...
	private TextView generateTextView(String text) {
		...
		tv.setTextColor(Color.parseColor("#8FACC8"));
		tv.setText(text);
	...
	protected void highLightTextView(int position) {
		...
		if (view instanceof TextView) {
			((TextView) view).setTextColor(Color.parseColor("#e5004f"));
		}
