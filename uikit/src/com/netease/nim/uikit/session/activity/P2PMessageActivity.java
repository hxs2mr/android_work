...
public class P2PMessageActivity extends BaseMessageActivity {
    ...
    static String name1;
    static String hos1;
    public static void start(Context context, String contactId, SessionCustomization customization, IMMessage anchor,String name,String hos) {
        name1 = name;
        hos1 = hos;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setStatusBarColor(this, Color.parseColor("#7FBEFF"));
        // 单聊特例话数据，包括个人信息，
        requestBuddyInfo();
        displayOnlineState();
    ...
    protected void initToolBar() {
        ...
        setToolBar(R.id.doctor_doctor_image,R.id.title_name,R.id.doctor_hosptil,R.id.doctor_back, options);
        TextView title_name= (TextView) findViewById(R.id.title_name);
        title_name.setText(name1);
        TextView doctor_hosptil= (TextView) findViewById(R.id.doctor_hosptil);
        doctor_hosptil.setText(hos1);
    }
}
