package microtech.hxswork.com.citypicker.city_20170724;
...
import microtech.hxswork.com.citypicker.R;
import microtech.hxswork.com.citypicker.citypickerview.widget.CanShow;
import microtech.hxswork.com.citypicker.citypickerview.widget.wheel.OnWheelChangedListener;
import microtech.hxswork.com.citypicker.citypickerview.widget.wheel.WheelView;
import microtech.hxswork.com.citypicker.citypickerview.widget.wheel.adapters.ArrayWheelAdapter;

/**
 * Created by microtech on 2017/9/26.
 */

public class PersonPickerView implements CanShow, OnWheelChangedListener {
     ...
     */
    private String defaultProvinceName = "16";
    ...
    private PersonPickerView(Builder builder) {
        ...
        this.mDistrictBeanArrayList=builder.mDistrictBeanArrayList;
        ...
        popview = layoutInflater.inflate(R.layout.pop_personpicker, null);
    ...
    public static class Builder {
        ...
        public Builder list(ArrayList<String> mDistrictBeanArrayList) {
            this.mDistrictBeanArrayList = mDistrictBeanArrayList;
            return this;
        }
        ...
        public PersonPickerView build() {
            PersonPickerView cityPicker = new PersonPickerView(this);
            return cityPicker;
        }
    ...
    private void setUpData() {
        ...
        mProvinceBeenArray = new String[4];
        for (int i = 0; i <4; i++)
        {
                mProvinceBeenArray[i] ="0"+(i+1)+"时";
        }
    ...
    protected void initProvinceDatas(Context context) {
        ...
        for (int i = 0; i <4; i++)
        {
                mProvinceBeanArrayList.add("0"+(i+1)+"时");
            mProvinceBeenArray[i] =i+"";
        }
