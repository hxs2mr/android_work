...
public class TimerPickerView implements CanShow, OnWheelChangedListener {
    ...
    private TimerPickerView(Builder builder) {
        ...
        popview = layoutInflater.inflate(R.layout.pop_hhmmpicker, null);
    ...
    public static class Builder {
        ...
        public TimerPickerView build() {
            TimerPickerView cityPicker = new TimerPickerView(this);
            return cityPicker;
        }
    ...
    private void setUpData() {
        ...
        mProvinceBeenArray = new String[24];
        for (int i = 0; i <24; i++)
        {
            if(i<10) {
                mProvinceBeenArray[i] =(i+1)+"";
            }else {
                mProvinceBeenArray[i] =""+(i+1);
            }
        }
    ...
    protected void initProvinceDatas(Context context) {
        ...
        {
            if(i<10) {
                mProvinceBeanArrayList.add(""+(i+1));
                mProvinceBeenArray[i] =""+(i+1);
            }else {
                mProvinceBeanArrayList.add(""+ (i + 1));
                mProvinceBeenArray[i] =""+ (i + 1);
