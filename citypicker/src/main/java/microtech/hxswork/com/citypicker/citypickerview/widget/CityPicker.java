...
import microtech.hxswork.com.citypicker.citypickerview.model.CityModel;
import microtech.hxswork.com.citypicker.citypickerview.model.DistrictModel;
import microtech.hxswork.com.citypicker.citypickerview.model.ProvinceModel;
import microtech.hxswork.com.citypicker.citypickerview.utils.XmlParserHandler;
...
public class CityPicker implements CanShow, OnWheelChangedListener {
    ...
    private CityPicker(Builder builder) {
        ...
        mRelativeTitleBg = (LinearLayout) popview.findViewById(R.id.rl_title);
